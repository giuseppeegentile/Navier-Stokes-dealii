...
/*     for (unsigned int c = 0; c < dim + 1; ++c)
    ...
    TrilinosWrappers::BlockSparsityPattern sparsity_stiffness(block_owned_dofs, MPI_COMM_WORLD);
    DoFTools::make_sparsity_pattern(dof_handler,coupling, sparsity_stiffness);
    sparsity_stiffness.compress();
    ...
    stiffness_matrix.reinit(sparsity_stiffness);
...
void
NavierStokes::output(std::string const file_name)
{
  pcout << "===============================================" << std::endl;
...
/* void
NavierStokes::assemble_stokes_system()
{
  pcout << "===============================================" << std::endl;
...
/* void
NavierStokes::solve_stokes_system()
{
  pcout << "===============================================" << std::endl;
